...
function __asyncjs__readWrapper() { return Asyncify.handleAsync(async () => { let line = await read(); writeLine(line); document.querySelector('body > console')?.setAttribute('read', line); window.scrollTo(window.scrollX, document.body.scrollHeight); }); }
...
var ___start_em_js = Module['___start_em_js'] = 112604;
var ___stop_em_js = Module['___stop_em_js'] = 112833;
