-- PROCEDURE: public.MODULE_GRADE_SUBROUTINE()

-- DROP PROCEDURE IF EXISTS public."MODULE_GRADE_SUBROUTINE"();

CREATE OR REPLACE PROCEDURE public."MODULE_GRADE_SUBROUTINE"(
	)
LANGUAGE 'plpgsql'
AS $BODY$
...
END 
$BODY$;
ALTER PROCEDURE public."MODULE_GRADE_SUBROUTINE"()
    OWNER TO postgres;
