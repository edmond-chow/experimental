...
function __asyncjs__ReadSync() { return Asyncify.handleAsync(async () => { let line = await iostream.readLine(); await iostream.writeLine(line, false); return getUTF32String(__asyncjs__ReadSync, line); }); }
function __asyncjs__WriteSync(Content) { return Asyncify.handleAsync(async () => { await iostream.write(UTF32ToString(Content)); }); }
function __asyncjs__NativePressAnyKey() { return Asyncify.handleAsync(async () => { await iostream.pressAnyKey(); }); }
...
// end include: preamble.js
  ...
  instrumentWasmImports:function(imports) {
        var importPatterns = [/^invoke_.*$/,/^fd_sync$/,/^__wasi_fd_sync$/,/^__asyncjs__.*$/,/^emscripten_promise_await$/,/^emscripten_idb_load$/,/^emscripten_idb_store$/,/^emscripten_idb_delete$/,/^emscripten_idb_exists$/,/^emscripten_idb_load_blob$/,/^emscripten_idb_store_blob$/,/^emscripten_sleep$/,/^emscripten_wget_data$/,/^emscripten_scan_registers$/,/^emscripten_lazy_load_code$/,/^_load_secondary_module$/,/^emscripten_fiber_swap$/,/^SDL_Delay$/,/^_emval_await$/];
...
init_emval();;
var wasmImports = {
  __asyncjs__ReadSync: __asyncjs__ReadSync,
  __asyncjs__WriteSync: __asyncjs__WriteSync,
...
var __Z12abort_unwindv = Module['__Z12abort_unwindv'] = () => (__Z12abort_unwindv = Module['__Z12abort_unwindv'] = wasmExports['_Z12abort_unwindv'])();
var __Z13invoke_atexitv = Module['__Z13invoke_atexitv'] = () => (__Z13invoke_atexitv = Module['__Z13invoke_atexitv'] = wasmExports['_Z13invoke_atexitv'])();
...
var dynCall_viiijjj = Module['dynCall_viiijjj'] = (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9) => (dynCall_viiijjj = Module['dynCall_viiijjj'] = wasmExports['dynCall_viiijjj'])(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9);
var dynCall_viiijjjj = Module['dynCall_viiijjjj'] = (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) => (dynCall_viiijjjj = Module['dynCall_viiijjjj'] = wasmExports['dynCall_viiijjjj'])(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11);
...
var ___start_em_js = Module['___start_em_js'] = 53064;
var ___stop_em_js = Module['___stop_em_js'] = 53457;
